...
## Project Structure
    ...
    ├── regressiontestsss_d_24337  # Django project configurations
...
1. Clone this repo and `cd regressiontestsss_d_24337`
...
2. Clone this repo and `cd regressiontestsss_d_24337`
